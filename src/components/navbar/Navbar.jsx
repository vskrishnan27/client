        ...
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="me-auto">
              ...
              <Nav.Link as={NavLink} to='checkbill'>Find sales bill</Nav.Link>
              
              <NavDropdown title="Product Updated Details" id="basic-nav-dropdown">
              <NavDropdown.Item as={NavLink} to='addbill'>Add bill</NavDropdown.Item>
